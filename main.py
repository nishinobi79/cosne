...
def plot_low_dims(tsne_embeddings, HT_SNE_embeddings, CO_SNE_embedding, learning_rate, learning_rate_for_h_loss, perplexity, early_exaggeration, student_t_gamma):
